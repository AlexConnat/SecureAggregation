...
def round1(pubkeys):
    ...
    # Store the keys received from the server, in the dictionnary CLIENT_STORAGE, for each client_sid
    ...
    # Store all the previously generated values, in client's dictionnary
...
if __name__ == '__main__':
    ...
    # This dictionnary will contain all the values generated by this client
    # and used in the aggregation
    global CLIENT_VALUES
    CLIENT_VALUES = {}

    # This dictionnary will contain all the values about the OTHER clients
